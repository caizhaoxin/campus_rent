// pages/views/source_of_good/source_of_good.js
...
Page({
  ...
  // 点击发布
  uploadGood:function(e){
    wx.navigateTo({
      url: '/pages/views/upload/Upload_good/Upload_good',
    })
  },
  /**
   * 生命周期函数--监听页面加载
  ...
  onShow: function () {
    console.log(app.globalData.haveSubmittedGoods + " wupinyuan onshow"); //noData
    console.log(this.data.noData + " wupinyuan onshow"); 
    if (app.globalData.haveSubmittedGoods == 1) {
      app.globalData.haveSubmittedGoods = 0;
      this.setData({
        getNum: 0,
        endIndex: 0,
        requirementList: [],
  ...
  scrolltolower: function (e) {
    var that = this;
    console.log(this.data.haveReachBottom +" scrolltolower");
    console.log(this.data.getNum + " scrolltolower");
